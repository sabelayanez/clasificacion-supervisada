...
def load_model():
    ...
    if modelo == "regresion_logistica_rgb":
        ...
        modelLR_rgb, scoresLR_rgb = regresion_logistica(X_train_rgb, y_train_encoded, X_train_rgb, y_test_encoded, class_names)
        save_excel_cv(scoresLR_rgb, "Regresión Logística RGB")

    elif modelo == "regresion_logistica_gray":
        ## si es regresión logística gray ##
        modelLR_gray, scoresLR_gray = regresion_logistica(X_train_gray, y_train_encoded, X_test_gray, y_test_encoded, class_names)
        save_excel_cv(scoresLR_gray, "Regresión Logística gray")

    elif modelo == "cnn_opcion_1":
        ## si es CNN1 ##
        cnn_cross_validation(X_train_rgb_64, y_train_encoded, X_test_rgb_64, y_test_encoded, class_names, 'cnn1', X_test_rgb_64, y_test_encoded)
        
    elif modelo == "cnn_opcion_2":
        ## si es CNN2 ##    
        cnn_cross_validation(X_train_rgb_64, y_train_encoded, X_test_rgb_64, y_test_encoded, class_names, 'cnn2', X_test_rgb_64, y_test_encoded)
        ...
        model_tree, scores_tree = arbol_decision_vgg16(X_train_rgb, y_train_encoded, X_test_rgb, y_test_encoded, class_names)
        # Evaluar el modelo con las funciones definidas previamente
        save_excel_cv(scores_tree, "Árbol de Decisión VGG16")
    elif modelo == "arbol_de_decision_vgg_pca":
        model_tree, scores_tree = arbol_vgg16_pca(X_train_rgb, y_train_encoded, X_test_rgb, y_test_encoded, class_names)
        # Evaluar el modelo con las funciones definidas previamente
        ...
        modelMobilenetv2 = train_mobilenetv2_model(X_train_rgb, y_train_onehot, X_test_rgb, y_test_onehot, y_test_encoded, class_names, epochs=10, batch_size=32, dense_units=1024, dropout_rate=0.5, learning_rate=0.001)
        ...
        modelRF_vgg_pca, scoresRF_vgg_pca = rforest_vgg16_pca(X_train_rgb, y_train_encoded, X_test_rgb, y_test_encoded, class_names)        
        ...
        _, scoresLR_rgb = regresion_logistica(X_train_rgb, y_train_encoded, X_train_rgb, y_test_encoded, class_names)
        save_excel_cv(scoresLR_rgb, "Regresión Logística RGB")
        ## regresión logística gray ##
        _, scoresLR_gray = regresion_logistica(X_train_gray, y_train_encoded, X_test_gray, y_test_encoded, class_names)
        save_excel_cv(scoresLR_gray, "Regresión Logística gray")
        ## CNN1 ##
        cnn_cross_validation(X_train_rgb_64, y_train_encoded, X_test_rgb_64, y_test_encoded, class_names, 'cnn1', X_test_rgb_64, y_test_encoded)
        ...
        ## KNN ## 
        _, _, scoresKNN = knn_with_gridsearch(X_train_rgb_64, y_train_encoded, X_test_rgb_64, y_test_encoded, class_names)
        save_excel_cv(scoresKNN, "KNN")
        ...
        model_tree_vgg16, scores_tree_vgg16 = arbol_decision_vgg16(X_train_rgb, y_train_encoded, X_test_rgb, y_test_encoded, class_names)
        #evaluar_rendimiento(model_tree_vgg16, X_test_rgb_64, y_test, "Árbol de Decisión VGG16")

        ## Árbol de Decisión VGG16 + PCA ##
        model_tree_pca, scores_tree_pca = arbol_vgg16_pca(X_train_rgb, y_train_encoded, X_test_rgb, y_test_encoded, class_names)
